...
runtime, the official Qwen3-1.7B Q8_0 GGUF, starter synthetic knowledge, and
third-party license files. Setup and the core case workflow do not require an
internet connection after the installer has been downloaded.
